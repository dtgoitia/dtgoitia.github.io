...
describe('Past Entry Tests', function() {
  ...
  it.skip('Join bar-index entries with the same index and return them in an object', function(){
    let arg1 = 13;
    let arg2 = [
  ...
  it.skip('Get number of years between 2 given dates', function(){
  ...
  it.skip('Get an array with the years to plot', function(){
